...
const { create, listAll, getOne, listMine, download, update, remove } = require('../controllers/resource.controller');
...
router.put('/:id', verifyToken, requireRole('teacher', 'admin'), resolveTeacherId, update);
